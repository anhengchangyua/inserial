...
public interface PermissionDao {
	...
	@Insert("insert into sys_permission(parentId, menuName, menuIcon, menuUrl, type, permission, sort) values(#{parentId}, #{menuName}, #{menuIcon}, #{MenuUrl}, #{type}, #{permission}, #{sort})")
